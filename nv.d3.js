...
nv.nearestValueIndex = function (values, searchVal, threshold) {
 ...
 It also has 'pointXValue', which is the conversion of mouseX to the x-axis scale.
 */
nv.interactiveGuideline2 = function () {
    "use strict";
    var tooltip = nv.models.tooltip();
    //Public settings
    var width = null
    ...
    function layer(selection) {
        selection.each(function (data) {
            ...
            //Draws a vertical guideline at the given X postion.
            layer.renderGuideLine = function (x, y) {
                if (!showGuideLine) return;
                var vline = wrap.select(".nv-interactiveGuideLine")
                    .selectAll("line.nv-vertical")
                    .data((x != null) ? [nv.utils.NaNtoZero(x)] : [], String);

                vline.enter()
                    .append("line")
                    .attr('class', 'nv-vertical nv-guideline')
                    ...
                    .attr("y2", 0)
                ;
                var hlines = wrap.select(".nv-interactiveGuideLine")
                    .selectAll("line.nv-horizontal")
                    .data((y != null) ? y : [], String);
                hlines.enter()
                    .append("line")
                    .attr('class', 'nv-horizontal nv-guideline')
                    .style("stroke-dasharray", ("3, 3"))
